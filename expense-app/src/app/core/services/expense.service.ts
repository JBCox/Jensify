...
export class ExpenseService {
  ...
  submitExpense(id: string): Observable<Expense> {
    ...
    return from(
      ...
      switchMap(() => {
        // Fetch updated expense with approval details
  ...
  splitExpense(
    ...
    return from(
      ...
      catchError((error) => {
        this.logger.error("Failed to split expense", error, "ExpenseService");
        this.notificationService.showError(
  ...
  unsplitExpense(expenseId: string): Observable<void> {
    return from(
      ...
      catchError((error) => {
        this.logger.error("Failed to unsplit expense", error, "ExpenseService");
        this.notificationService.showError(
